...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 27 21:26:57 2019
...
#Emid = .5*(E[:,:-1] + E[:,1:]) 
#
#p = np.array([0,5,7,9,11,13,15,17,19,21,35]) # arbitrary periods
...
#
#for idx, _ in enumerate(pmid):                     # loop over period mid-point indexes 
